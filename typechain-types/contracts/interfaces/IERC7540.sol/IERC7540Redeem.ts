...
export interface IERC7540RedeemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IERC7540Redeem extends BaseContract {
  connect(runner?: ContractRunner | null): IERC7540Redeem;
  waitForDeployment(): Promise<this>;

  interface: IERC7540RedeemInterface;
